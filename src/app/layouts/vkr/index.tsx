    ...
    <div className={styles.flexRow}>
      ...
      <div className={styles.flexCol3}>
        <div className={styles.text}>
          ...
          <small>
            Если у вас есть заказчик, вы можете заполнить с ним данные документы
            и передать на их кафедру
          </small>
        </div>
        <div className={styles.filler}></div>
        <div
      ...
      <div className={styles.flexCol3}>
        <div className={styles.text}>
          ...
          <small>
            Документы необходимо заполнить, распечатать, подписать и отнести на
            кафедру
          </small>
        </div>
        <div className={styles.filler}></div>
